                ...
                <div class="flex flex-warp -m-4">
                    ...
                    @if($datas->complete =='1')
                        <div
                            ...
                            <a href="#">
                                <h5 class="mb-2 line-through text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                                    {{ $datas->message }}</h5>
                            </a>
                            
                            <a href="{{ url('/complete', $datas->id) }}"
                                class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-500 cursor-not-allowed rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Task Done!
